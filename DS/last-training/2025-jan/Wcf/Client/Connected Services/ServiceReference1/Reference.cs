...
namespace Client.ServiceReference1 {
    ...
    public interface IChatService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IChatService/sendMessage")]
        System.Threading.Tasks.Task sendMessageAsync(string username, string messageContent);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IChatServiceCallback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IChatService/CallbackNotifyReceiver")]
        void CallbackNotifyReceiver(Client.ServiceReference1.ChatMessage message);
    }
    ...
    public partial class ChatServiceClient : System.ServiceModel.DuplexClientBase<Client.ServiceReference1.IChatService>, Client.ServiceReference1.IChatService {
        ...
        public void sendMessage(string username, string messageContent) {
            base.Channel.sendMessage(username, messageContent);
        }
        
        public System.Threading.Tasks.Task sendMessageAsync(string username, string messageContent) {
            return base.Channel.sendMessageAsync(username, messageContent);
        }
    }
}
